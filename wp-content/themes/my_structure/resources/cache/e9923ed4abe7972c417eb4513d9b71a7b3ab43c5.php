...
<header x-data="{ open: false }" class="p-6 bg-white lg:pb-0">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center justify-between h-16 lg:h-20">
            <a href="<?php echo e(get_home_url(null, '/en', 'https')); ?>" title="<?php echo e(__('Home', 'text_domain')); ?>" class="flex">
...
<?php /**PATH /Users/editweb2/Sites/01progetti-test/pac/wp-content/themes/my_structure/resources/views/partials/header-menu-english.blade.php ENDPATH**/ ?>