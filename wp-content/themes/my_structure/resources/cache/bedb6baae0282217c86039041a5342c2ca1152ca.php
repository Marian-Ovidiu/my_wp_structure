    ...
    <div class="container flex flex-col items-center px-4 py-12 mx-auto text-center">
        ...
        <div class="mt-6">
            <?php if($cta_missione_dona_ora_url): ?>
                <a href="<?php echo e($cta_missione_dona_ora_url); ?>" aria-label="<?php echo e($cta_missione_dona_ora_titolo); ?>"
            ...
            <?php if($cta_missione_galleria_url): ?>
                <a href="<?php echo e($cta_missione_galleria_url); ?>" aria-label="<?php echo e($cta_missione_galleria_url); ?>"
